...
{
	// before the start, apply "required" HTML5 attribute to all required elements
	$(".field > span.required").parent().find(":input").attr({required: "required"});
	
	$("#fg-base-edit").validator({
		position: 'top center', 
		offset: [-22, 0],
