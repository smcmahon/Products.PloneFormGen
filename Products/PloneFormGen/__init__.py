...
try:
    try:
        from archetypes import TALESField
    except ImportError:
        from Products import TALESField
    try:
        from archetypes import TemplateFields
    except ImportError:
        from Products import TemplateFields
    try:
        from archetypes import PythonField
    except ImportError:
        from Products import PythonField
except ImportError:
