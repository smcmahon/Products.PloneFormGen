...
stringValidators = (
    {'id':'isEmail',
        'title': _('validator_isemailaddress_text',
    ...
    {'id':'isCommaSeparatedEmails',
        'title': _('validator_isemailaddresslist_text',
    ...
    {'id':'isPrintable',
        'title': _('validator_onlyprintable_text',
    ...
    {'id':'isURL',
        'title': _('validator_isurl_text', default=u'Is a well-formed URL'),
        'errmsg': _('pfg_isURL', default=u'This is not a valid url.'),
        'regex':r'(%s)s?://[^\s\r\n]+' % '|'.join(protocols),
        'ignore':'',
    },
    {'id':'isUSPhoneNumber',
        'title': _('validator_isusphone_text',
    ...
    {'id':'isInternationalPhoneNumber',
        'title': _('validator_isintphone_text',
    ...
    {'id':'isZipCode',
        'title': _('validator_iszipcode_text',
    ...
    {'id': 'isNotLinkSpam',
        'title': _('validator_isnotlinkspam_text',
